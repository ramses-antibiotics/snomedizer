...
* by using `concepts_descendants()`
* by running an ECL query in the `concepts_find(ecl = "...")` function. For this, you will want to use the `<<` operator (known as `descendantOrSelfOf`) using ECL. 
