...
By default, the package uses the official [SNOMED International server](https://browser.ihtsdotools.org/snowstorm/snomed-ct/), which is subject to [terms & conditions use](#terms-&-conditions) and limited to reference purposes.
...
SNOMED International allows access to public SNOMED-CT terminology servers to anyone for strict 'reference purposes' under the [SNOMED International SNOMED CT Browser License Agreement](https://browser.ihtsdotools.org/).
